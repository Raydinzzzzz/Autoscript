...
wget https://raw.githubusercontent.com/Raydinzzzzz/Autoscript/main/cf.sh && chmod +x cf.sh && ./cf.sh
#install ssh ovpn
...
wget https://raw.githubusercontent.com/Raydinzzzzz/Autoscript/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh
#install trojan-go
